...
| [Production deployment](deployment/production.md) (draft)                                | Name and domain check, hosting providers, configuration, release checks  |
...
| `deployment/`   | Local development, production deployment, Docker, CI/CD                                 |
