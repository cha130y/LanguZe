...
7. **Tutor:** tool calling with the three read-only tools of the [AI tutor flow](../../flows/ai-tutor.md#2-tools), streamed to the learner, with at most 5 tool rounds and an overall time limit of 30 seconds, both configurable.
