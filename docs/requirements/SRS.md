...
- **Document status:** Draft v0.6 — values marked `(Vn)` were chosen while writing this SRS; their status is in [Appendix B](#appendix-b-values-chosen-while-writing-the-srs)
- **Date:** 2026-09-19
